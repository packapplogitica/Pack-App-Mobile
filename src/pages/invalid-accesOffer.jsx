        ...
        <Grid gutter={25}>
          <Grid.Col md={6} order={2} orderMd={1}>
            <HeaderSection
              ...
              content="Esta no es tu oferta, inicia sesion con la cuenta correspondiente para acceder a los detalles"
            />
...
export default InvalidAccesOffer;